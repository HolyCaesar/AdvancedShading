...
void CommandSignature::Finalize(const DX12RootSignature* RootSignature)
{
    if (m_Finalized)
        return;
    ...
    ASSERT_SUCCEEDED(
        IGraphics::g_GraphicsCore->g_pD3D12Device->CreateCommandSignature(&CommandSignatureDesc, pRootSig,
