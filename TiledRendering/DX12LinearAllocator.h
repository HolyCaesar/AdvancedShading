...
{
	kInvalidAllocator = -1,
	kGpuExclusive = 0, // Defautl GPU-writable (via UAV)
...
class DX12LinearAllocatorPageManager
{
public:
	DX12LinearAllocatorPageManager();
	...
	// Discard pages will be destroyed once their fence has passed.
...
{
public:
	DX12LinearAllocator(LinearAllocatorType Type) :
...
private:
	...
	static DX12LinearAllocatorPageManager sm_PageManager[2];
