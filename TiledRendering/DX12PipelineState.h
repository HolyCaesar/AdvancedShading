...
{
public:
	DX12PSO() : m_RootSignature(nullptr) {}
	
	static void DestroyAll(void);

	void SetRootSignature(const DX12RootSignature& BindMappings)
	{
		m_RootSignature = &BindMappings;
	}

	const DX12RootSignature& GetRootSignature(void) const
	{
...
class GraphicsPSO : public DX12PSO
{
...
class ComputePSO : public DX12PSO
{
    friend class CommandContext;
