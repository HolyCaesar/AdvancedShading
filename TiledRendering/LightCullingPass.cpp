...
//
//	m_LightCullingComputeRootSignature.Reset(e_numRootParameters, 0);
//	//m_LightCullingComputeRootSignature.InitStaticSampler(0, non_static_sampler);
//	m_LightCullingComputeRootSignature[e_rootParameterCB].InitAsDescriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE_CBV, 0, e_cCB);
//	m_LightCullingComputeRootSignature[e_rootParameterOLightIndexCounterUAV].InitAsBufferUAV(0);
//	m_LightCullingComputeRootSignature[e_rootParameterTLightIndexCounterUAV].InitAsBufferUAV(1);
//
//	m_LightCullingComputeRootSignature[e_rootParameterOLightIndexListUAV].InitAsBufferUAV(2);
//	m_LightCullingComputeRootSignature[e_rootParameterTLightIndexListUAV].InitAsBufferUAV(3);
//	m_LightCullingComputeRootSignature[e_rootParameterOLightGridUAV].InitAsDescriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE_UAV, 4, 1);
//	m_LightCullingComputeRootSignature[e_rootParameterTLightGridUAV].InitAsDescriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE_UAV, 5, 1);
//	//m_LightCullingComputeRootSignature[e_rootParameterOLightGridUAV].InitAsBufferUAV(4);
//	//m_LightCullingComputeRootSignature[e_rootParameterTLightGridUAV].InitAsBufferUAV(5);
//	m_LightCullingComputeRootSignature[e_rootParameterFrustumSRV].InitAsBufferSRV(0);
//	m_LightCullingComputeRootSignature[e_rootParameterLightsSRV].InitAsBufferSRV(1);
//	//m_LightCullingComputeRootSignature[e_rootParameterDepthSRV].InitAsBufferSRV(2);
//	m_LightCullingComputeRootSignature[e_rootParameterDepthSRV].InitAsDescriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 2, 1);
//	// TODO need to add RW texture to the room signature
//	//m_LightCullingComputeRootSignature[e_rootParameterSRV].InitAsDescriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 0, e_cSRV);
//
//
//	m_LightCullingComputeRootSignature[e_rootParameterDebugUAV].InitAsBufferUAV(6);
//
...
//
//
//		m_computePSO.SetRootSignature(m_LightCullingComputeRootSignature);
